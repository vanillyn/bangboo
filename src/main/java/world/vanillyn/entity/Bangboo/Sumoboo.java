...
public class Sumoboo extends Bangboo {
    public Sumoboo(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        return this.handleInteractMob(player, hand, new ItemStack(BangbooItems.BANGBOO_CORE_SUMOBOO));
    }
    ...
    public Identifier getBangbooTexture() {
        return BangbooMod.id("textures/entity/bangboo/sumoboo/sumoboo.png");
    }
}
