...
public class Luckyboo extends Bangboo {
    public Luckyboo(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        return this.handleInteractMob(player, hand, new ItemStack(BangbooItems.BANGBOO_CORE_LUCKYBOO));
    }
    ...
    public Identifier getBangbooTexture() {
        return BangbooMod.id("textures/entity/bangboo/luckyboo/luckyboo.png");
    }
}
