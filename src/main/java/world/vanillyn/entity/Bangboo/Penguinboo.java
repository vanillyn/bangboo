...
public class Penguinboo extends Bangboo {
    public Penguinboo(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        return this.handleInteractMob(player, hand, new ItemStack(BangbooItems.BANGBOO_CORE_PENGUINBOO));
    }
    ...
    public Identifier getBangbooTexture() {
        return BangbooMod.id("textures/entity/bangboo/penguinboo/penguinboo.png");
    }
}
