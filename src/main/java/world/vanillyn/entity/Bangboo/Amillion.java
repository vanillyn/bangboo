...
public class Amillion extends Bangboo {
    public Amillion(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        return this.handleInteractMob(player, hand, new ItemStack(BangbooItems.BANGBOO_CORE_AMILLION));
    }
    ...
    public Identifier getBangbooTexture() {
        return BangbooMod.id("textures/entity/bangboo/amillion/amillion.png");
    }
}
